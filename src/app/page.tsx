    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          {/* Main Headline */}
          <h1 className="font-heading text-charcoal text-7xl sm:text-8xl md:text-[10rem] lg:text-[13rem] font-bold tracking-[-0.06em] leading-[0.85] mb-4 animate-fade-in-up">
            BUILT
            <br />
